...
public class C05_IntegerVar {
	...
	public static void main(String[] args) {
		...
		//변수를 선언하면서 초기값을 주었습니다
		byte m1 = 100;
		short m2 = 100;
		int m3 = 100;
		long m4 = 100;
		
		int curruntNo; //변수명은 실제 저장되는 값이 파악되는 단어로 만듭니다
//		System.out.println(n1); //오류: 값이 없는 변수, 초기값이 없습니다.
		System.out.println(m1);
		
		//값의 대입(=)
		n1 = 123; //대입문 오른쪽 값 /수식 / 변수가 왼쪽 변수로 대입됨
				  // 123은 4바이트 리터럴. byte와 short는 별도 리터럴 표기방식이 없습니다
				  // 자동으로 값이 넘치지 않으면 1바이트 또는 2바이트로 크기가 바뀌어 저장됩니다.
//		n1 = 999; //오류 +127보다 큰값
		n2 = 29999;
//		n2 =-40000; //오류 -32768 보다 작은값
		n3 = 123456789;
//		n3 = 1234567890123; //오류 +2147483647 보다 큰값
//		n4 = 1234567890123; //오류  +1234567890123 리터럴은 int리터럴이므로 표현오류
		n4 = 123; 			//오류아님 123 리터럴은 int 리터럴 표현범위
