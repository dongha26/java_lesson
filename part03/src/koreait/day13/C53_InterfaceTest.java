...
// 참조 타입에 따른 메소드 실행             : z1,z2,z3에 어떤 메소드 실행 가능한지?		
		z1.methodA();
		z1.methodB(23);
		z1.name("쯔위");
		...
		z2.methodA();
		z2.methodB(23);
//		z2.name("쯔위"); 오류 : InterfaceB의 추상 메서드로 실행 못함
		
//		z3.methodA();	오류 : InterfaceA의 추상 메서드로 실행 못함
//		z3.methodB(23);	오류 : InterfaceA의 추상 메서드로 실행 못함
		z3.name("쯔위");
		
// 캐스팅 : *다중구현체*의 인터페이스 타입 캐스팅
//			ㄴ MyClassZ 는 InterfaceA와 InterfaceB 타입으로 모두 참조할 수 있는 구현체
